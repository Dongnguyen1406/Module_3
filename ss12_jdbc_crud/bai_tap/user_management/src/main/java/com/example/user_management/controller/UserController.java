...
public class UserController extends HttpServlet {
    ...
    public void searchByCountry(HttpServletRequest req, HttpServletResponse resp) throws SQLException, ServletException, IOException {
    ...
    public void sortByName(HttpServletRequest req, HttpServletResponse resp) throws SQLException, ServletException, IOException {
